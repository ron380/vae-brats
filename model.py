...
def green_block(inp, filters, data_format='channels_first', name=None,kernel_initializer='glorot_normal'):
    """
...
def loss(input_shape, inp, out_VAE, z_mean, z_var, e=1e-8, weight_L2=0.1, weight_KL=0.1):
    ...
    def loss_(y_true, y_pred):
        ...
        return  1 - loss_dice + weight_L2 * loss_L2 + weight_KL * loss_KL

    return loss_


def build_model(input_shape=(4, 160, 192, 128), output_channels=2, weight_L2=0.1, weight_KL=0.1,kernel_initializer='glorot_normal'):
    """
    ...
    x = green_block(x, 256, name='Enc_256_1',kernel_initializer=kernel_initializer)
    x = green_block(x, 256, name='Enc_256_2',kernel_initializer=kernel_initializer)
    x = green_block(x, 256, name='Enc_256_3',kernel_initializer=kernel_initializer)
    x4 = green_block(x, 256, name='x4',kernel_initializer=kernel_initializer)
